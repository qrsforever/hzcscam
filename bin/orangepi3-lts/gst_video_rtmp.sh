...
# http://101.42.139.3:30808/players/rtc_player.html?vhost=seg.300s&ip=192.168.152.185&api=31985&app=live&stream=orangepizero2
    ...
    then
        ...
        then
            gst-launch-1.0 v4l2src device=${VIDEO_DVICE} io-mode=4 ! \
                ...
                flvmux streamable=true ! rtmpsink location=rtmp://${RTMP_DOMAIN}/live/${BOARD}?vhost=seg.300s
        fi
    fi
    sleep 5
done
